...
description: >
  ...
  Use when user asks to review bad cases, audit feedback, check AI accuracy, or says /odin-op-bad-case-audit.
---
...
**Depends on:** `odin-data-clickhouse` (for ClickHouse queries), `odin-data-langfuse-trace` (for trace analysis)
...
Or manually via the `odin-data-clickhouse` skill:
